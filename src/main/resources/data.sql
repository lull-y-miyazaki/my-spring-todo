...
(2, 1, 'ゲームの作り方', '2025-12-31', 1, 'ゲームの作り方を明日までに考える'),
(3, 1, 'コーヒー豆の煎り方', '2025-12-31', 2, 'コーヒー豆の煎り方を明日までにマスターする'),
(1, 2, '請求', '2025-12-31', 0, '請求金額を明日までに提出'),
(2, 2, '漫画の描き方', '2025-12-31', 1, '漫画の描き方を明日までにマスターする'),
(3, 3, 'リマインド', '2025-12-31', 2, '明日までにリマインドをする');